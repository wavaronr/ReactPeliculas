  ...
  return (
    ...
    <div className=" container-xxl bg-dark">
      ...
      <Routes>
        ...
        <Route exact path="/Listado" element={ <Listado App={{addOrRemoveFromFavs}}/>} key="listado" >
        </Route>
        <Route exact path="/Detalle" element={<Detalle/>} key="detalle" >
        </Route>
         {/* App is the name of the props de funtions for to send favs */}
        <Route exact path="/Resultados" element={<Resultados App={{addOrRemoveFromFavs}}/>} key="resultados" >
        </Route>
        <Route exact path="/Cards" element={<Cards/>} key="cards" >
        </Route>
        <Route exact path="/Favoritos" element={<Favoritos  App={{addOrRemoveFromFavs}} favorites={favorites} />} key="favorfavoritos" >
        </Route>

        
        <Route exact path="/Calendario" element={<Calendario/>} key="Calendario" >
        </Route>
